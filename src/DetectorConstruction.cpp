...
DetectorConstruction::DetectorConstruction(): G4VUserDetectorConstruction()
{
    ...
    msg_->DeclareProperty("density", density_,"density.");
    msg_->DeclareProperty("pressure", pressure_,"pressure.");
...
G4Material* DetectorConstruction::DefineNeon() const
{
  ...
  if (!material) {
    G4double density = density_ * kg/m3;
    G4double pressure = pressure_ * bar;
    G4double temperature = temperature_ * kelvin;
